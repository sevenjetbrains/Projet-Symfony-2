...
class Booking
{
     ...
     * @assert\GreaterThan(propertyPath="startDate",message="la date de départ doit étre éloignée à la date d'arrive !")
     */
    private $endDate;
...
// 1)il faut connaitre les dates qui sont impossibles pourl'annonce
...
// 2) il faut comparer les dates choisies avec les dates impossibles
    ...
    //Tableau des chaines de caractéres de me journées
