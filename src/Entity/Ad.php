...
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100,minMessage="Votre description ne peut pas faire moins de 100 caractéres")
     */
    private $content;
...
/**
 * Permet de récupérer le commentaire d'un autheur par rapport à annonce
 *
 * @param User $author
...
public function getavgRatings(){
    //Clculer la somme des notations
    $sum=array_reduce($this->comments->toArray(),function($total,$comment){return $total+$comment->getRating();},0);
